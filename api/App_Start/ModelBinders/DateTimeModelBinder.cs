...
namespace TemplateApi.Api.App_Start.ModelBinders
{
    public class DateTimeModelBinder : IModelBinder
    {
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            if (value == null)
            {
                if (modelType == typeof(DateTime?) || modelType == typeof(DateTimeInput))
                {
            ...
            else if (DateTimeInput.TryParse(value, out DateTimeInput result))
            {
                if (modelType == typeof(DateTimeInput))
